...
class TravelTasks:
    def plan_itinerary(self, agent, city, travel_dates, interests):
        ...
        return Task(
                    ...
                    expected_output="A detailed 7-day travel itinerary with daily schedules, hotel and restaurant recommendations, packing tips, weather forecast, and budget breakdown.",
                    agent=agent)
    ...
    def identify_city(self, agent, origin, cities, interests, travel_dates):
        ...
        return Task(description = dedent(f"""**Task**: Choose the Best Travel Destination
                    ...
                    expected_output="A detailed report on the selected destination including weather conditions, seasonal events, travel costs, and key attractions.",
                    agent=agent)
        ...
        return Task(description = dedent(f""" **Task**: Compile a Comprehensive City Guide  
                                    ...
                                    **Key Insights to Include**:
                                        ...
                                        **Travel Details**:
                                            ...
                                            - Traveler Interests: {interests}
                                            - Travel Dates: {travel_dates}"""),
                    expected_output="A comprehensive city guide covering top attractions, local customs, cultural experiences, seasonal events, and practical travel tips.",
                    agent=agent)
